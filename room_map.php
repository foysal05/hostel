                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Student Seat Map</h2>
                ...
                <div class="ecommerce-widget">
                   ...
                   <div class="row col-10">
                    ...
                    if ($rowcount<$row['room_capacity']) {
                            ...
                            <a  style="border: 1px solid gray; color: white" class="btn btn-<?php echo $sign; ?> col"><?php echo $row['room_no']; ?> &nbsp; Cap: <?php echo $row['room_capacity']; ?></a>
