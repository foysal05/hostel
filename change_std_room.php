...
if ($sign=='danger') {
 ...
 <a href="#" style="border: 1px solid gray; color: white" class="btn btn-<?php echo $sign; ?> col">Booked</a>
  ...
  ?>
 <a href="db/db_change_seat.php?sid=<?php echo $_GET['vid']; ?>& room_no=<?php echo $row['room_no']; ?>&sign=<?php echo $sign; ?>" style="border: 1px solid gray; color: white" class="btn btn-<?php echo $sign; ?> col">Change</a>
<?php
}
    ?>
