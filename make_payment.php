                    ...
                    <div class="col">
                      <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="text" required="" onkeypress="return isNumberKeyND(event)"  placeholder="Student ID" class="form-control" name="std_id">
                        </div>
                    </div>
                </div>
                <div class="col">
                                ...
                                while($row_payment=mysqli_fetch_array($sql_result, MYSQLI_ASSOC)){
                                    ...
                                    <tr>
                                        <form action="db/db_payment.php" method="post">
                                            ...
                                            <td><?php echo $row_payment['due']; ?></td>
                                            <td><?php echo $row_payment['date']; ?></td>
                                            <td><input type="submit" class="btn btn-info" name="due_payment" value="Payment"></td>
                                        </form>
                                    </tr>
                                    <?php
                                }
                            ...
                            foreach ($filteredFoos as $month) {
                                ...
                                <tr>
                                    <form action="db/db_payment.php" method="post">
                                        ...
                                        <td><input type="submit" class="btn btn-info" name="payment" value="Payment"></td>
                                    </form>
                                </tr>
                                <?php
                                $u++;
...
<?php
    ...
    echo '<h2>Student Information Not Found</h2>';
}
}
