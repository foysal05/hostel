            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Student Profile</h2>

                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php" class="breadcrumb-link">Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="students.php" class="breadcrumb-link">Student</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"></li>Student Profile (<?php echo $_GET['id']; ?>)
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<?php 
    if (isset($_GET['email'])=='send') {
        ...
        <div class="alert alert-success alert-dismissible">
          ...
          <strong>Success!</strong> Account Access Information Resend Successfully.
      </div>
      <?php
              ...
              <div id="user-profile-2" class="user-profile">
                <div class="tabbable">
                    ...
                    <div class="tab-content no-border padding-24">
                        <?php
                        $query="SELECT * FROM student, guardian WHERE student.std_id=guardian.sid_id AND v_id='".$_GET['id']."'";
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-3 center">
                                            <span class="profile-picture">
                                                <img class="editable img-responsive" alt=" Avatar" id="avatar2" src="db/<?php echo $row['photo']; ?>" width="200" hight="200">
                                            </span>

                                            <div class="space space-4"></div>

                                            <a href="edit_student.php?update&id=<?php echo $row['std_id']; ?>" class="btn btn-sm btn-block btn-success">
                                                <i class="ace-icon fa fa-edit bigger-120"></i>
                                                <span class="bigger-110">Update Info</span>
                                            </a>
                                             <a style="color:black" href="resend_email.php?resend&id=<?php echo $row['v_id']; ?>&pass=<?php echo $row['password']; ?>&email=<?php echo $row['g_email']; ?>" class="btn btn-sm btn-block btn-info">
                                                <i class="fas fa-paper-plane"></i>
                                                <span class="bigger-110">Resend Access Code</span>
                                            </a>

                                            <a href="db/db_student.php?delete&id=<?php echo $row['std_id']; ?>" class="btn btn-sm btn-block btn-danger">
                                        ...
                                        <div class="col-xs-12 col-sm-9">
                                            <h4 class="blue">
                                                <span class="middle"><?php echo $row['fullname']; ?></span>
                                            ...
                                            <?php
                                            // $sql="SELECT * FROM guardian WHERE sid_id='".$row['std_id']."'";
                                            ...
                                            //     while($row=mysqli_fetch_array($result2, MYSQLI_ASSOC)){
                                                    ...
                                                    <div class="profile-info-row">
                                                      ...
                                                      <div class="profile-info-value">
                                                        <a mail-to="" ><?php echo $row['g_email']; ?></a>
                                                    </div>
                                                </div>
                                                <div class="profile-info-row">
                                                  <div class="profile-info-name"> Phone </div>
