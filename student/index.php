...
<div class="dashboard-wrapper">
    ...
    if(mysqli_num_rows($result2)>0){
        while($row=mysqli_fetch_array($result2, MYSQLI_ASSOC)){
            ...
            ?>
                            <div class="col-md-2 text-light bg-dark" style=" font-size: 2em">
                                <?php echo $row['heading']; ?>
                            </div> 
                            <div class="col-md-8">

                                <MARQUEE style="font-size: 2em; color:white" SCROLLAMOUNT=10 BGCOLOR=#28A745> <?php echo $row['body']; ?></MARQUEE>
                            ...
                            <div class="col-md-2" style=" font-size: 2em">
                                <a class="btn btn-info" href="notice_board.php">All Notice</a>
                            </div> 
                        </div>
                        <br>
                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"></li>Student Profile (<?php echo $_SESSION['v_id']; ?>)
                                </ol>
                            </nav>
                        </div>
                    </div>
              ...
              <div id="user-profile-2" class="user-profile">
                <div class="tabbable">
                    ...
                    <div class="tab-content no-border padding-24">
                        <?php
                        $query="SELECT * FROM student WHERE v_id='".$_SESSION['v_id']."'";
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-3 center">
                                            <span class="profile-picture">
                                                <img class="editable img-responsive" alt="<?php echo $_SESSION['fullname']; ?>" id="avatar2" src="../db/<?php echo $row['photo']; ?>" width="200" hight="200">
                                            </span>
                                            ...
                                            if(mysqli_num_rows($result2)>0){
                                                while($row2=mysqli_fetch_array($result2, MYSQLI_ASSOC)){
                                                    ...
                                                    <div class="profile-info-row">
                                                      ...
                                                      <div class="profile-info-value">
                                                        <a mail-to="" ><?php echo $row2['g_email']; ?></a>
                                                    </div>
                                                </div>
                                                <div class="profile-info-row">
                                                  <div class="profile-info-name"> Phone </div>
