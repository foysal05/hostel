            ...
            <div class="card-body">
                <form action="../db/db_login.php" method="post">
                    <div class="form-group">
                        <input class="form-control form-control-lg" id="username" type="text" name="v_id" placeholder="Student ID" required="" autocomplete="off">
                    </div>
                    <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <button type="submit" name="std_login" style="background-color: #F4623A; color: white" class="btn  btn-lg btn-block">Sign in</button>
                </form>
            </div>
