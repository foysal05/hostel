                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered first">
                                ...
                                <tbody>
                                    <?php
                                    $query="SELECT * FROM complain,student WHERE complain.std_id=v_id";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status']=='Pending') {
                                                        ?>
<a href="db/db_complain.php?done&id=<?php echo $row['c_id'];?>" class="btn btn-danger btn-xs"> <i class="fas fa-arrow-circle-down"></i></a> 
                                                        <?php
                                                    }else{
                                                        ?>
   <a href="#" class="btn btn-success btn-xs"> <i class="fas fa-check-circle"></i></a>  
                                                    ...
                                                    <a href="db/db_complain.php?delete&id=<?php echo $row['c_id'];?>" class="btn btn-danger btn-xs"> <i class="fas fa-trash"></i></a>   
                                                </td>
